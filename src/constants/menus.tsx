import { CarotSort, CreditCard, Home } from "@/icons"
...
export const HOVER_MENU: HoverMenuProps[] = [
    {
        ...
        desc: "Gamified approach to impart basic financial knowledge.",
    ...
    },
    {
        ...
        desc: "AI based analysis of bank statements to provide insights.",
        path: "/upload-docs",
    ...
    },
    {
        id: 3,
        label: "Optimized EMI",
        desc: "AI based consultation to optimize EMI payments.",
        path: "/ai-consult",
    ...
    },
    {
        ...
        desc: "AI based comparison of credit lenders.",
