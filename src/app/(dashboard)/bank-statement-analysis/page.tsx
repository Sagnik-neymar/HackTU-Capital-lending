...
const Page = () => {
  ...
  return (
    <div className="flex justify-center items-center">
        ...
        {active && typeof active === "object" ? (
          <div className="fixed inset-0  grid place-items-center z-[100]">
            ...
            <motion.div
              ...
              ref={ref}
              className="w-full max-w-[800px]  h-full md:h-fit md:min-h-[30rem]  flex flex-col justify-center items-center bg-white dark:bg-neutral-900 sm:rounded-3xl overflow-hidden"
            >
              <motion.div layoutId={`image-${active.title}-${id}`}>
                <img
                  ...
                  src={active.src}
                  alt={active.title}
                  className="w-full h-80 lg:h-96 sm:rounded-tr-lg sm:rounded-tl-lg object-fill object-top"
                />
              </motion.div>
                ...
                <div className="flex justify-between items-start p-4">
                  <div className="w-full">
                    <motion.h3
                      ...
                      className="font-semibold text-neutral-700 text-center dark:text-neutral-200 text-base"
                    >
                      {active.title}
                    </motion.h3>
                    {/* <motion.p
      ...
      <ul className=" mx-auto  flex w-[50rem] min-h-[95vh] items-center justify-center flex-wrap gap-4">
